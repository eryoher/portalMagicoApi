...
const TOKEN = 'TEST-4162175641553215-081420-696d25072b00310b8133f083cf544e71-236778780'; //SandBox
const _TOKEN = 'APP_USR-4162175641553215-081420-b4177e24c5758a2e325198970908b2bf-236778780';
        ...
        try {
            ...
            if (params.type) {
                ...
                if (payment.status == 'approved') {
                    ...
                    const user = await Notification.app.models.users.findOne({ where: { email: preference.payer.email } });
                    const quantityOrder = preference.items[0].quantity;
                    const dataCard = {
                    ...
                    await Promise.all([
                        sendGiftCard(req, dataCard, quantityOrder),
